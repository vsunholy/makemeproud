...
const messages = {
  ...
  delete_success: { msg: 'Knyga sėkmingai istrinta!', type: 'success' },
...
app.get('/show/:id', (req, res) => {
  ...
  const data = {
    pageTitle: `Rodyti knyga${book.title}`,
    domain: domain,
    ...book
  };
  const html = template(data);
...
app.post('/store', upload.single('cover'), (req, res) => {
  ...
  const uploadFileName = req.file?.filename; // req.file egzistuoja tik jei yra
